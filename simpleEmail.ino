 ...
 * DESCRIPCION: Este sketch sen encarga de enviar un correo electrónico a uno o varios destinatarios usando
 *              la librería ESP_Mail_Client, smtp de gmail por el puerto 465.
...
// WiFi
#define WIFI_SSID "JADSA CORP"
#define WIFI_PASSWORD "Taquiperenda2021"
...
#define AUTHOR_EMAIL "jadsaDevServices@gmail.com"
#define AUTHOR_PASSWORD "DevServices2021"
...
void setup()
{
  ...
  */
  ...
  message.sender.name = "Jadsa Tv";
  message.sender.email = AUTHOR_EMAIL;
  message.subject = "Correo de Prueba";
  message.addRecipient("Jhimmy", "jadsa@gmx.com");
